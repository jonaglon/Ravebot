...
tuneInfo tuneLibRave[11] = {
  {149,128, 144,  0, 16,  0, 16, 16},  // TripToTheMoonPt2-Acen
  {136, 40, 112,  0, 16,  0, 16, 16},  // Bombscare-2BadMice
  {126,  0, 136,  0,  8,  0, 16,  0},  // LFO-LFO  
  {132,  0, 136,  0, 16,  0, 16, 16},  // Infiltrate202-Altern8 
  {122,  0, 118,  0, 16,  0, 16, 16},  // DirtyCash-SoldOutMix
  {122,  0, 108,  0,  8,  8, 16,  0},  // Break4Love-Raze
  {126,  0,  96,  0,  8,  0, 16, 12},  // IsThereAnybodyOutThere-Bassheads
  {128,  0,  80,  0,  8,  4,  8,  0},  // PacificState-808State
  {150,  0, 155,  0,  0,  0, 16, 16},  // OutOfSpace-Prodigy
  {124,  0, 168,  0, 16,  0, 16,  0},  // WhatCanYouDoForMe-UtahSaints
  {132,  0, 162,  0, 16,  0, 16, 16}   // Breathe-Prodigy
};
...
tuneInfo tuneLibRockAndPop[11] = {
  {160,  0, 117,  4,  4,  4,  4,  0},  // KidsInAmerica-KimWilde
