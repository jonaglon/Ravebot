...
tuneInfo tuneLibDance[15] = {
  {134, 29, 119,  0,  4,  4,  0},  //1 A rinky dinky
  {110, 58,  91,  0,  4,  4,  0},  //2 Kelis - Trick Me
  {150, 25, 130,  4,  4,  4,  0},  //3 Dubbleedge - Lips to the floor
  {134,105, 169,  0,  4,  4,  0},  //4 Zero Emit Collect
  {125, 70, 102,  0,  4,  4,  0},  //5 Dizee Bonkers
  {115, 56,  88,  0,  4,  4,  0},  //6 RizzleKicks - DownWithTheTrumpets
  {168, 92, 181,  0,  4,  4,  0},  //7 OneTime
  {130,  0, 162,  0,  4,  4,  0},  //8 WileOut - DJ Zinc
  {145,  0, 170,  0,  4,  4,  0},  //9 Aphex - Polynomial C
  {124,  0, 189,  0,  4,  4,  0},  //10 Aphex WindowLicker
...
/*
  {000,  0, 000,  0,  4,  4,  0},  //16 SomeSong-Someone
  {000,  0, 000,  0,  4,  4,  0},  //17 SomeSong-Someone
  {000,  0, 000,  0,  4,  4,  0},  //18 SomeSong-Someone
  {000,  0, 000,  0,  4,  4,  0},  //19 SomeSong-Someone
  {000,  0, 000,  0,  4,  4,  0},  //20 SomeSong-Someone  
//  bpm drop tuneLength maxFadeIn minFadeOut maxFadeOut dropOffset  */

// Genre 6, Drum&Bass
tuneInfo tuneLibDrumAndBass[20] = {
  {176,  0, 182, 16,  0, 16,  0},  //1 Girls-DJHypeAndPotential
  {176,  0, 185, 16,  8, 16, 16},  //2 DuppyMan-ChaseAndStatusCapleton
  {176,  0, 252,  0,  4,  4,  0},  //3 TheNine-BadCompany
  {176,  0, 200, 16,  4,  4,  0},  //4 GoldDigger-HighContrast
  {176,  0, 248,  0,  4,  4,  0},  //5 ShakeUrBody-ShyFX
  {176,  0, 132,  0,  4,  4,  0},  //6 KingOfTheBeats2016-Aphrodite
  {176,  0, 181,  0,  4,  4,  0},  //7 LastNight-BennyPage
  {176,  0, 212,  0,  4,  4,  0},  //8 TurnDownTheLights-BennyPage
  {176,  0, 157,  0,  4,  4,  0},  //9 PassTheKutchie-BennyPage
  {176,  0, 169,  0,  4,  4,  0},  //10 PassMeTheRizla-Deekline
  {176,  0, 232,  0,  0,  0,  0},  //11 CryingOut-BennyPageSerialKillazMix
  {179,  0, 108,  0,  0,  0,  0},  //12 LivingInJungles-BedouinSoundclash
  {179,  0, 274,  0,  0,  0,  0},  //13 Blade Runner Flip Side
  {176,  0, 224,  0,  0,  0,  0},  //14 BamBam-SerialKillaz
  {176,  0, 224,  0,  0,  0,  0},  //15 NoNoNo-SerialKillaz  
  {000,  0, 000,  0,  4,  4,  0},  //16 SomeSong-Someone
  {000,  0, 000,  0,  4,  4,  0},  //17 SomeSong-Someone
  {000,  0, 000,  0,  4,  4,  0},  //18 SomeSong-Someone
  {000,  0, 000,  0,  4,  4,  0},  //19 SomeSong-Someone
...
tuneInfo tuneLibHipHop[20] = {
  {101, 25,  81,  4,  0,  8,  8},  //1 Lets get ill
  { 90,  0, 108,  4,  0, 16,  0},  //2 No Diggidy
  { 97, 49,  66,  4,  0, 16,  0},  //3 ShimmyShimmyYa-ODB
  {103, 69, 122,  4,  0,  8,  8},  //4 Moma said knock you out    
  {154, 65, 140,  4,  0,  8,  0},  //5 Bigger than hip hop
  { 93, 61, 108,  8,  0,  8,  8},  //6 DropItLikeItsCloseToMe-Snoop
  { 98,  0, 101,  4,  0,  8,  8},  //7 OPP-NaughtyByNature
  {100,  0, 105,  0,  4,  4,  0},  //8 HipHopHooray
  {106,  0,  91,  0,  0,  8,  0},  //9 JumpAround-HouseOfPain
  {106,  0,  88,  2,  0, 16,  0},  //10 InsazlleInTheBazzle-CyprusHazzle
  {108,  0, 101,  0,  2,  8,  6},  //11 KingKunta-KendrickLamar
  { 95,  0,  82,  8,  0,  8,  8},  //12 GinAndJuice-Snoop
  {108,  0,  97,  8,  0,  8,  8},  //13 HotInHere-Nelly
  { 92,  0, 133,  4,  4,  8,  0},  //14 CaliforniaLove-DreAnd2Pac
  { 97,  0,  80,  8,  0,  8,  0},  //15 TheOnlyOne-DangermouseJemini  
  { 93,  0, 102,  8,  4,  4,  0},  //16 FamilyAffair-MaryJBlige
  { 93,  0,  60,  8,  0,  8,  8},  //17 HitsFromTheBong-CypressHill
  { 96,  0,  98,  8,  0,  8,  8},  //18 Regulate-WarrenG
  { 90,  0,  77,  8,  0,  8,  8},  //19 GetUrFreakOn-MissyElliot
  { 96,  0,  80,  4,  0,  8,  8},  //20 GoldDigger-Kanye
};
